...
install: pademelon-daemon pademelon-tools
	...
	install -Dm755 src/pademelon-widgets -t ${DESTDIR}${PREFIX}/bin
...
uninstall:
	rm -f ${DESTDIR}${PREFIX}/bin/pademelon-daemon \
		${DESTDIR}${PREFIX}/bin/pademelon-settings \
		${DESTDIR}${PREFIX}/bin/pademelon-widgets \
		${DESTDIR}${PREFIX}/bin/xdg-xmenu \
		${DESTDIR}${PREFIX}/bin/pademelon-tools
