...
tools.o: src/tools.c src/common.h src/x11-utils.h src/desktop-daemon.h
...
pademelon-tools: pademelon-tools.o tools.o common.o x11-utils.o signals.o desktop-daemon.o
	$(CC) $(LDFLAGS) $(INIHLIB) $(X11LIB) $(IMLIB2LIB) -o $@ $^
