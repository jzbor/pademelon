...
struct tool tools[] = {
    ...
    { "launch-application", "launch pademelons application choice",     tl_launch_application },
    { "select-application", "print pademelons application choice",      tl_select_application },
